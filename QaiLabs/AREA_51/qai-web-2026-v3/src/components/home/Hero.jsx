        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-qai-light">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 pt-20">
                ...
                >
                    ...
                    <p className="text-lg font-medium text-qai-dark">
                    ...
                    >
                        <a
                            href="#cases"
                            className="px-8 py-4 bg-qai-dark text-white rounded-full font-medium text-lg hover:bg-black transition-all shadow-lg flex items-center group border border-transparent"
                        >
                            Ver Casos Reales
